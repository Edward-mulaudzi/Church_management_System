# Generated by Django 3.2.12 on 2024-05-29 23:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('security_present', models.CharField(max_length=250)),
                ('security_absent', models.CharField(max_length=250)),
                ('security_total', models.CharField(max_length=250)),
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='managementSystem.church_branch')),
            ],
        ),
        migrations.CreateModel(
