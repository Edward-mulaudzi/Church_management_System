...
urlpatterns = [
    ...
    # path('AddUsersForm/', views.AddUsersForm, name="AddUsersForm"),
    path('MonitoringTool', views.MonitoringTool, name="MonitoringTool"),
    ...
    path('AddHealthMember/', views.AddHealthMember, name="AddHealthMember"),
    path('AddLCDC_Management/', views.AddLCDC_Management, name="AddLCDC_Management"),
    path('AttendancePresent', views.AttendancePresent, name="AttendancePresent"),
    ...
    path('AddHealthMemberForm/', views.AddHealthMemberForm, name="AddHealthMemberForm"),
    ...
    path('ViewAllHealthMembers', views.ViewAllHealthMembers, name="ViewAllHealthMembers"),
    ...
    path('deleteHealthMember/<int:id>', views.deleteHealthMember, name='deleteHealthMember'),
    ...
    path('updateHealthMember/<int:id>', views.updateHealthMember, name='updateHealthMember'),
    ...
    path('ViewSTudentAttendanceMornitoringTool/<int:id>', views.ViewSTudentAttendanceMornitoringTool, name='ViewSTudentAttendanceMornitoringTool'),
]